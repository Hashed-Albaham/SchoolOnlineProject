...
## آخر تحديث: 2026-03-06T05:01:00+03:00
...
### 🟡 المرحلة 2 - ميزات متبقية (2 مهمتين):
...
| الملف | الوصف |
|---|---|
| `app/Policies/EnrollmentPolicy.php` | [NEW] من يمكنه عرض/تعديل/حذف الاشتراكات |
| `app/Policies/MessagePolicy.php` | [NEW] من يمكنه عرض/حذف الرسائل |
| `app/Policies/QuizPolicy.php` | [NEW] من يمكنه إنشاء/تعديل/حذف الاختبارات |
| `app/Providers/AuthServiceProvider.php` | [MODIFY] تسجيل الـ Policies |

**قواعد الصلاحيات:**
- **EnrollmentPolicy**: Admin يدير الكل، Tutor يرى اشتراكات دوراته فقط، Student  يرى اشتراكاته فقط
- **MessagePolicy**: المرسل أو المستقبل فقط يرى الرسالة، Admin يرى الكل
- **QuizPolicy**: المعلم صاحب الكورس + Admin فقط يعدل الاختبار
...
- **المرحلة 2 جزئية**: 5/6 (MSG1 ✅, A8 ✅, PP1 ✅, PAY ✅, T1 ✅) | **متبقي**: PL, TD1
- **المرحلة 3**: 0/4 (FR, SD, CLEAN, PG)
