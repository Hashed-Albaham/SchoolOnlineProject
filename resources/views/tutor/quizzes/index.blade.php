    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">اختبارات الكورس</h2>
            ...
            <div class="bg-luxury-800/50 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-right">
                            <thead class="bg-white/5 border-b border-white/10 text-luxury-300">
                                <tr>
                                    <th class="px-6 py-4 font-semibold">عنوان الاختبار</th>
                                    <th class="px-6 py-4 font-semibold">عدد الأسئلة</th>
                                    <th class="px-6 py-4 font-semibold">المدة (دقيقة)</th>
                                    <th class="px-6 py-4 font-semibold">نسبة النجاح</th>
                                    ...
                                    <tr class="hover:bg-white/5 transition">
                                        ...
                                        <td class="px-6 py-4 flex items-center gap-3">
                                            ...
                                            <form action="{{ route('tutor.courses.quizzes.destroy', [$course, $quiz]) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="text-red-400 hover:text-red-300 text-sm">حذف</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                @else
                    <div class="p-12 text-center text-luxury-400">
                        ...
                        <p class="text-lg">لا توجد اختبارات مضافة لهذا الكورس بعد.</p>
                    </div>
                @endif
            </div>
        </div>
