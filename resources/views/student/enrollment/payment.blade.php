            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mb-6 pb-6 border-b">
                        ...
                        <p class="text-sm text-gray-500">بواسطة: {{ $enrollment->course->tutor->name }}</p>
                    </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
                        <p class="text-sm text-yellow-800">
                            <strong>ملاحظة:</strong> هذه محاكاة لعملية الدفع. في الإنتاج الفعلي، سيتم التكامل مع بوابة
                            دفع حقيقية.
                        </p>
                    </div>
                    ...
                    <form action="{{ route('student.enrollment.payment.process', $enrollment) }}" method="POST">
                        ...
                        <!-- Fake Card Input -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">رقم البطاقة (للعرض فقط)</label>
