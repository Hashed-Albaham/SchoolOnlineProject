<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-white">{{ __('site.edit_category') }}: {{ $category->name }}</h2>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_ar" value="{{ old('name_ar', $category->name_ar) }}"
                                class="w-full px-4 py-3 rounded-xl bg-luxury-700/50 border border-white/10 text-white focus:outline-none focus:border-gold-500/50" dir="rtl">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                class="w-full px-4 py-3 rounded-xl bg-luxury-700/50 border border-white/10 text-white focus:outline-none focus:border-gold-500/50">{{ old('description', $category->description) }}</textarea>
                        </div>
